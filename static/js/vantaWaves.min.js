        ...
        constructor(t = {}) {
          ...
          i('resize', this.resize),
            ...
            this.options.touchControls &&
              (i('touchstart', { passive: true }, this.windowTouchWrapper),
    ...
    17: function(t, e, i) {
      ...
      class r extends s.b {
        ...
        onInit() {
          ...
          ;(this.cameraPosition = new n.Vector3(240, 100, 390)),
            (this.cameraTarget = new n.Vector3(0, -100, 190)),
        ...
        onMouseMove(t, e) {
          ...
          return (
            i.oy ||
              ...
              (i.ox = i.position.x),
              (i.oz = i.position.z)),
            (i.tx = i.ox + (100 * (t - 2)) / this.options.zoom),
            (i.ty = i.oy + (-100 * (e - 2)) / this.options.zoom),
            (i.tz = i.oz + (-50 * (t - 2)) / this.options.zoom)
          )
        }
      }
